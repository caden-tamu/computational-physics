...
int main() {
    ...
    double anglesToTest[] = {15.0,25.0,35.0, 36.5, 45.0}; //First test angles
    double distanceToShore = 235.0;

    std::ofstream impactFile("Impact_Speed_Rain.csv");
    impactFile << "theta,impact_speed\n";


    for (double angle : anglesToTest) {
        string file1 = "Trajectory_Rain_Of_" + std::to_string((int)angle) + "_Degrees.csv";
    ...
    string bestFile = "Best_Trajectory_" + std::to_string((int)bestAngle) + "_Degrees.csv";
