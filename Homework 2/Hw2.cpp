...
int main() {
    ...
    double anglesToTest[] = {15.0,25.0, 27.0, 28.0, 35.0, 45.0}; //First test angles
    double distanceToShore = 235.0;

    std::ofstream impactFile("Impact_Speed.csv");
    impactFile << "theta,impact_speed\n";


    for (double angle : anglesToTest) {
        string file1 = "Trajectory_Of_" + std::to_string((int)angle) + "_Degrees.csv";
